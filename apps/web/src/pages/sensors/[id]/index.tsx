...
const SensorPage = ({ id }: SensorPageProps) => {
  ...
  return (
  <><div className="visible lg:invisible lg:mb-0 mb-4 text-center">
      <Subtle>Information about your sensor</Subtle>
    </div>
    <div className="grid min-h-[calc(100vh-6rem)] w-11/12 grid-cols-1 md:w-full md:gap-x-2 md:px-4 lg:grid-cols-3">
        {isLoading ? (
            ...
            <>
              <div
                className={cn(
                  ...
                  "bg-slate-50 shadow-md transition-all duration-300 lg:p-4 p-0",
                  "flex flex-col items-center justify-start",
                  "h-[calc(100vh-12rem)] lg:h-auto lg:mt-2"
                )}
              >
                {sensorWithFillLevel ? (
                  <>
              ...
              <div className="col-span-1 lg:col-span-1 lg:h-auto">
                <div className="mb-4 lg:mt-4 mt-0 flex flex-col items-center justify-start">
                  <div className="flex flex-row gap-x-2 mt-6 lg:mt-0">
                    <H3>{data.sensor.name}</H3>
                  </div>
                  <Subtle className="invisible lg:visible">Information about your sensor</Subtle>
                </div>
                ...
                <div className="mx-auto max-w-md">
                  ...
                  >
                    <div className="flex h-8 items-center">
                      <Badge
                        size="sm"
                        color={sensorWithFillLevel && sensorWithFillLevel
